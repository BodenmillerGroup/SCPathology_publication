...
#Check in validation cohort!
cluster_match = cluster_match[order(as.numeric(Basel)),]
#Read in order from output
p_dat = p_dat[as.character(rev(cluster_match[order(match(cluster_match$Basel[cluster_match$Basel %in% hr$labels[hr$order]],hr$labels[hr$order])),zuri])),]
